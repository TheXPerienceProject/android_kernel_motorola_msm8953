 ...
 *
 * Added code to make more intelligent throttlig this is a msm thermal modified 
 * some changes are made by different developers.
 * Renamed and modified to maintain the original thermal driver untouched.
 * Copyright (C) 2016-2018 The XPerience Project
 *
 * Changes:Check temperature only if probed
 * This avoids a (harmless) error by MyFluxi
 * thermal: Add sysfs nodes to control parameters by neobuddy89 
 *
 */
...
#define MSM_THERMAL_NAME "alessa_thermal"
